...
![GitHub Pages](https://img.shields.io/badge/Live%20Demo-GitHub%20Pages-brightgreen)

---

## 🚀 Live Demo — Open in Browser

> **No installation required.** Click any link below to open directly in your browser.

| Simulation | Live Link | What It Shows |
|-----------|-----------|--------------|
| 🎬 Production Control Room | [**Open Demo →**](https://tariksalih412.github.io/st2110-learning-lab/control-room-v2.html) | Vision Switcher, Multiviewer, VU Meters, Waveform Monitor |
...
| 🗺️ Architecture Diagram | [**Open Demo →**](https://tariksalih412.github.io/st2110-learning-lab/smpte2110-diagram-en.html) | Full ST 2110 system annotated reference |
...
st2110-learning-lab/
│
├── control-room-v2.html          # Full Production Control Room
├── smpte2110-noc-v2.html         # Network Operations Center
├── tv-channel-sim-v2.html        # End-to-end TV Channel Simulation
├── smpte2110-simulation-v2.html  # Fault Injection Simulator
├── smpte2110-diagram-v2.html     # ST 2110 Architecture Reference
│
└── README.md
```
